...
public:
	...
	void heartBeat(std::string & userInput, sf::TcpSocket& socket, sf::SocketSelector* selector, int &commandNumber, int &serverID, BoardManager * _BoardManager, BoardManager * _AIBoard , std::pair<int, int> shot);
